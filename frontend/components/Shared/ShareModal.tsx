...
interface ShareModalProps {
    isOpen: boolean;
    onClose: () => void;
    resourceType: ShareGrantRequest['resource_type'];
...
const ShareModal: React.FC<ShareModalProps> = ({
    ...
    useEffect(() => {
        ...
        const load = async () => {
            setLoadingList(true);
            try {
                const data = await listShares(resourceType, resourceUid);
                setRows(data);
            } catch (err: any) {
        ...
        load();
    }, [isOpen, resourceType, resourceUid]);
    ...
    return (
        ...
        >
            ...
            >
                ...
                {(resourceType === 'project' || resourceType === 'area') &&
                    resourceUid && (
                        <InviteLinkSection
